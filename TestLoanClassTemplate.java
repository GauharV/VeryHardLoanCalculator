/**
 * Samuel Taiwo & Gauhar Veeravalli
 * Course: CSC.251
 * Date: 4/27/2026
 *
 * A loan calculator that calculates monthly interest, total payment, and total interest using
...
public class TestLoanClassTemplate {
  ...
  public static void extraPayEveryMonth(LoanTemplate l, double extraPay) {
	  ...
	  while (myLoanAmount >= (myMonthlyPayment + extraPay)) {
          ...
          double newMonthInterest = myLoanAmount * (myMonthlyInterestRate/100);
		  // caculate the principal paid this month from myMonthlyPayment minus the new month's interest
          principal = myMonthlyPayment - newMonthInterest;
